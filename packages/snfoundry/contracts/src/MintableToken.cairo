...
pub mod MintableToken {
    ...
    //default config, i could set decimal on my own
    ...
    // Ownable Mixin
    // Mixin to use all that components external funcs and integrate them in ABI
    #[abi(embed_v0)]
    ...
    impl MintableTokenImpl of IMintableToken<ContractState> {
        ...
        }// @ makes compiler to give you read access, no need storagereadaccess
...
// default cofig - decimal, supply. 
// If i remove that i have to set those 2 manually. 


// I am using storagepointerread/writeaccess, why i am using it, then what's the use of storeagereadaccess
